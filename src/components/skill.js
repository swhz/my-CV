...
const Skill = () => {
    const skillArray = [
        ...
        {class:'iconfont icon-javascript',title:'JS',desc:'熟练运用Javascript，掌握JS新标准ES6、ES7的语法特性(类，箭头函数，解构赋值等)。'},
        ...
        {class:'iconfont icon-Programming',title:'其他编程语言',desc:'熟练运用Fortran、Matlab，掌握C++，了解node.js、php、python。'}
    ]
    return (
